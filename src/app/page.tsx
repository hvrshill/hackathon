...
export default function Home() {
  return (
    <div className="space-y-16">
      {/* Hero Section */}
      <section className="text-center py-20 bg-[#] text-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex justify-center space-x-4">
            <Link
              href="/auth/signup"
              className="bg-[#3a2d2d] bg-opacity-80 text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#3a2d2d] hover:bg-opacity-90"
            >
              Get Started
            </Link>
            <Link
      ...
      <section className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 bg-[#4b3d22] rounded-lg shadow-md">
      ...
      <section className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={category}
              className="p-6 bg-[#ac712e] rounded-lg shadow-md text-center hover:shadow-lg transition-shadow"
            >
              <h3 className="font-semibold text-[#ac712e]">{category}</h3>
            </div>
          ))}
        </div>
      </section>
